...
@section('content')
    ...
    @foreach($events as $event)
            <div class="card col-md-4 col-xs-10">
                <img class="card-img-top" src="assets/images/douich.jpg" alt="">
                <div class="card-body">
                    <h4 class="card-title blue text-center">{{$event->title}} <div class=" text-right small "> <i class="fa fa-calendar"></i> {{$event->date}}</div></h4>
